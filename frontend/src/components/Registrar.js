            ...
            <form id='infoCliente'>
                ...
                <div className="row">
                    <div className="mb-3 col">
                        ...
                        <input type="text" className="form-control" id="rfcInput" aria-describedby="RFC" maxLength={13} pattern="[A-Z]{4}[0-9]{6}[A-Z0-9]{3}" required/>
                    </div>
                    <div className="mb-3 col">
                        <label htmlFor="curpInput" className="form-label">CURP</label>
                        <input type="text" className="form-control" id="curpInput" aria-describedby="RFC" maxLength={18} pattern="[A-Z]{4}[0-9]{6}[H|M]{1}[A-Z]{2}[A-Z0-9]{5}" required/>
                    </div>
                </div>
                <div id='botones'>
